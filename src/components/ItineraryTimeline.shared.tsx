  ...
  return (
    <View style={timelineCardContainerStyle}>
      <View style={styles.row}>
        ...
        <Pressable onLongPress={onLongPress ?? legacyOnLongPress} delayLongPress={200} style={[styles.card, { backgroundColor: '#FFFFFF', borderWidth: 0, borderColor: 'transparent', padding: 18, borderRadius: 16, marginBottom: 16, shadowColor: '#000000', shadowOpacity: 0.05, shadowRadius: 12, shadowOffset: { width: 0, height: 2 }, elevation: 1 }, active && styles.cardActive, isDragging && styles.draggingCard]}>
...
const styles = {
  ...
  transition: { alignSelf: 'flex-start', width: 'auto', maxWidth: '100%', minWidth: 0, gap: 4, marginLeft: 24, marginTop: -2, marginBottom: 6, paddingVertical: 4, paddingHorizontal: 10, borderRadius: 999, backgroundColor: '#F1F5F9', borderWidth: 0, borderColor: 'transparent', borderLeftWidth: 2, borderLeftColor: EDITORIAL_COLORS.line } as const,
