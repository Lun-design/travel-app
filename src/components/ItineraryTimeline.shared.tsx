  ...
  return (
    <View style={timelineCardContainerStyle}>
      ...
      <View style={styles.row}>
        ...
        <View style={[styles.card, { backgroundColor: '#FFFFFF', borderWidth: 0, borderColor: 'transparent', padding: 18, borderRadius: 16, marginBottom: 16, shadowColor: '#000000', shadowOpacity: 0.05, shadowRadius: 12, shadowOffset: { width: 0, height: 2 }, elevation: 1 }, active && styles.cardActive]}>
...
const cardMenuStyles = StyleSheet.create({
  ...
  triggerRow: { position: 'absolute', top: 3, right: 8, zIndex: 5, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: 8 },
