...
const webGripStyle: React.CSSProperties = { width: 24, minHeight: 44, display: 'grid', placeItems: 'center', flexShrink: 0, marginLeft: 8, marginRight: 8, borderRadius: 0, background: 'transparent', color: '#CBD5E1', opacity: 0.4, fontSize: 20, fontWeight: 900, userSelect: 'none', touchAction: 'none' };
