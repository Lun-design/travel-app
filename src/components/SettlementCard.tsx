...
const styles = StyleSheet.create({
  card: { width: '100%', maxWidth: '100%', overflow: 'hidden', boxSizing: 'border-box', backgroundColor: '#eff6ff', borderRadius: 16, padding: 16, gap: 10, marginBottom: 14 },
  ...
  settlementText: { flex: 1, minWidth: 0, color: '#334155' },
  amount: { maxWidth: '42%', flexShrink: 0, fontSize: 13, fontWeight: '800', color: '#1d4ed8', textAlign: 'right' },
  empty: { color: '#64748b', textAlign: 'center' },
  hint: { color: '#2563eb', fontSize: 12, fontWeight: '700' },
  modalBackdrop: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24, backgroundColor: 'rgba(15,23,42,.45)' },
  modalCard: { width: '100%', maxWidth: 360, alignItems: 'center', gap: 8, padding: 24, borderRadius: 24, backgroundColor: 'white' },
  modalTitle: { color: '#0f172a', fontSize: 22, fontWeight: '800' },
  modalText: { color: '#64748b', textAlign: 'center' },
