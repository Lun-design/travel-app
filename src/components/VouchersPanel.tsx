...
const styles = StyleSheet.create({
  container: { padding: 4, paddingBottom: 100, gap: 10 },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  title: { fontSize: 21, fontWeight: '800' },
  subtitle: { color: '#64748b', marginTop: 3 },
  upload: { backgroundColor: '#2563eb', borderRadius: 12, paddingHorizontal: 15, paddingVertical: 11 },
  white: { color: 'white', fontWeight: '800' },
  card: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'white', borderRadius: 15, padding: 14, borderWidth: 1, borderColor: '#e2e8f0' },
